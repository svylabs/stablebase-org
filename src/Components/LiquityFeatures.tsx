...
const LiquityFeatures: React.FC = () => {
    return (
        <>
            <div className="flex flex-col lg:flex-row gap-3 md:px-8 lg:gap-10 lg:px-16 xl:gap-14 xl:px-36 p-3 bg-slate-900">
                <div className="rounded-lg p-3 py-6 hover:bg-slate-800 hover:shadow-lg hover:scale-105 transform transition-transform duration-300 ease-in-out">
